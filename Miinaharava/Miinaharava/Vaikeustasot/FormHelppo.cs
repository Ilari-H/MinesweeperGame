...
{
    public partial class FormHelppo : Form 
    {
        int koko = 9;
        int MINES = 10;             //monta miinaa luodaan taululle
        int aika = 0;               //ÄLÄ VAIHDA
        int korkein = 9;            //korkein numero mikä taulukossa voi olla 
        int lippumaara = 10;        //Täytyy olla sama kuin MINES
        int oikeatliput = 10;       //tämä pitää samana kuin lippumaara
        ...
        private void button_Clicked(object sender, EventArgs e)
        {
            ...
            if (m.GetMiina())
            {
                ...
                {
                    this.Close();
                    FormHelppo FormHelppo = new FormHelppo();
                    FormHelppo.Show();
                    FormHelppo.StartPosition = FormStartPosition.CenterScreen;
                    this.Dispose(false);
        ...
        {
            string message = "Haluatko Lopettaa pelin vaikeustaso helppo";
        ...
        }                   //kirjoittaa ajan paneelin aika kohtaan
